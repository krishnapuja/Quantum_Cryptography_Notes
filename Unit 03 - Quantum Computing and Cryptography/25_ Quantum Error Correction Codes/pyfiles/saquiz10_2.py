...
#Displays curent question of total questions
def makeEnd():
...
#Logic to display part two of question if answer is true and has yet to be displayed
def launchifneeded():
...
#Check answer based on selected fields
...
#Clear yes and no btns
def clearbtns():
    clearbtn(btn_yes)
    clearbtn(btn_no)

#disables yes and no btn
def disablebtns():
    btn_yes.disabled=True
    btn_no.disabled=True

#enables next btn and clears yes and no btns
def answerpress(btn):
    clearbtns()
